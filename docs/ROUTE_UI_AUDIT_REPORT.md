...
## 1. Header
- Timestamp: 2026-08-23T08:38:55.013Z
...
| Module files scanned | 117 |
| Component files | 117 |
| Reachable component files | 66 |
| Orphan component files | 51 |

## 3. Global layout chain (from src/app/layout.tsx and AppShell)
```txt
- src/app/layout.tsx [65 lines] (root)
  ...
  - AppShell -> src/components/layout/AppShell.tsx [43 lines] (imported-file)
    - Footer -> src/components/layout/Footer.tsx [123 lines] (imported-file)
    - Header -> src/components/layout/Header.tsx [375 lines] (imported-file)
      - SearchBar -> src/app/components/SearchBar.tsx [339 lines] (imported-file)
        - StockLogo -> src/app/components/StockLogo.tsx [52 lines] (imported-file)
      - ThemeToggle -> src/components/ui/ThemeToggle.tsx [38 lines] (imported-file)
...
| /ipo | src/app/ipo/page.tsx | 458 | - | - |
| /ipo/[ipoId] | src/app/ipo/[ipoId]/page.tsx | 819 | - | - |
| /learn | src/app/learn/page.tsx | 373 | - | - |
| /login | src/app/login/page.tsx | 256 | - | - |
| /market | src/app/market/page.tsx | 1535 | - | Tabs, TabsList, TabsTrigger, TabsContent |
...
| /stock-search | src/app/stock-search/page.tsx | 170 | - | - |
| /stocks | src/app/stocks/page.tsx | 2392 | - | - |
| /stocks/[symbol] | src/app/stocks/[symbol]/page.tsx | 1195 | - | Tabs |
...
- Intrinsic UI elements: div, h2, p, section
- Tab systems: -
- Nested component tree:
```txt
- src/app/page.tsx [218 lines] (root)
  - AnalysisFeatures -> src/components/home/AnalysisFeatures.tsx [706 lines] (imported-file)
  - CtaSection -> src/components/home/CtaSection.tsx [148 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
    - AnimatedCounter -> src/components/home/CtaSection.tsx [148 lines] (internal-component)
  - FeaturedStocks -> src/components/home/FeaturedStocks.tsx [333 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
  - HeroSection -> src/components/home/HeroSection.tsx [196 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
  - IpoSection -> src/components/home/IpoSection.tsx [337 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
  - MarketNetworkSection -> src/components/ui/market-network-section.tsx [112 lines] (imported-file)
  ...
  - MarketOverview -> src/components/home/MarketOverview.tsx [216 lines] (imported-file)
  - SectionReveal -> src/components/ui/SectionReveal.tsx [23 lines] (imported-file)
  - SectorPerformance -> src/components/home/SectorPerformance.tsx [135 lines] (imported-file)
  - SectionHeader -> src/app/page.tsx [218 lines] (internal-component)
```
...
- Nested component tree:
```txt
- src/app/api-test/page.tsx [144 lines] (root)
```
...
- Direct child components: -
- Internal child components: -
- Intrinsic UI elements: button, div, form, h1, h2, input, option, p, select, textarea
- Tab systems: -
- Nested component tree:
```txt
- src/app/auth/profile/page.tsx [228 lines] (root)
```
...
- src/app/blog/page.tsx [494 lines] (root)
  - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
...
- Direct child components: Accordion -> src/components/ui/accordion.tsx; AccordionContent -> src/components/ui/accordion.tsx; AccordionItem -> src/components/ui/accordion.tsx; AccordionTrigger -> src/components/ui/accordion.tsx; Button -> src/components/ui/button.tsx; Card -> src/components/ui/card.tsx; CardContent -> src/components/ui/card.tsx; CardDescription -> src/components/ui/card.tsx; CardHeader -> src/components/ui/card.tsx; CardTitle -> src/components/ui/card.tsx; IpoEmptyState -> src/components/IPO/IpoPanels.tsx; IpoEntryCard -> src/components/IPO/IpoPanels.tsx; IpoMetricCard -> src/components/IPO/IpoPanels.tsx; PremiumSection -> src/components/IPO/IpoPanels.tsx; Table -> src/components/ui/table.tsx; TableBody -> src/components/ui/table.tsx; TableCell -> src/components/ui/table.tsx; TableHead -> src/components/ui/table.tsx; TableHeader -> src/components/ui/table.tsx; TableRow -> src/components/ui/table.tsx
- Internal child components: -
- Intrinsic UI elements: a, div, h1, li, main, p, section, span, ul
- Tab systems: -
- Nested component tree:
```txt
- src/app/ipo/page.tsx [458 lines] (root)
  ...
  - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
  - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardDescription -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - IpoEmptyState -> src/components/IPO/IpoPanels.tsx [271 lines] (imported-file)
    - Badge -> src/components/ui/badge.tsx [36 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardDescription -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
    - FactTile -> src/components/IPO/IpoPanels.tsx [271 lines] (internal-component)
  - IpoEntryCard -> src/components/IPO/IpoPanels.tsx [271 lines] (imported-file)
    - Badge -> src/components/ui/badge.tsx [36 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    ...
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
    - FactTile -> src/components/IPO/IpoPanels.tsx [271 lines] (internal-component)
  - IpoMetricCard -> src/components/IPO/IpoPanels.tsx [271 lines] (imported-file)
    - Badge -> src/components/ui/badge.tsx [36 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    ...
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
    - FactTile -> src/components/IPO/IpoPanels.tsx [271 lines] (internal-component)
  - PremiumSection -> src/components/IPO/IpoPanels.tsx [271 lines] (imported-file)
    - Badge -> src/components/ui/badge.tsx [36 lines] (imported-file)
    - Button -> src/components/ui/button.tsx [54 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
...
- Direct child components: Accordion -> src/components/ui/accordion.tsx; AccordionContent -> src/components/ui/accordion.tsx; AccordionItem -> src/components/ui/accordion.tsx; AccordionTrigger -> src/components/ui/accordion.tsx; Badge -> src/components/ui/badge.tsx; Button -> src/components/ui/button.tsx; Card -> src/components/ui/card.tsx; CardContent -> src/components/ui/card.tsx; CardDescription -> src/components/ui/card.tsx; CardHeader -> src/components/ui/card.tsx; CardTitle -> src/components/ui/card.tsx; IpoEmptyState -> src/components/IPO/IpoPanels.tsx; IpoMetricCard -> src/components/IPO/IpoPanels.tsx; PremiumSection -> src/components/IPO/IpoPanels.tsx; Table -> src/components/ui/table.tsx; TableBody -> src/components/ui/table.tsx; TableCell -> src/components/ui/table.tsx; TableHead -> src/components/ui/table.tsx; TableHeader -> src/components/ui/table.tsx; TableRow -> src/components/ui/table.tsx
- Internal child components: -
- Intrinsic UI elements: a, div, h1, main, p, section, span
- Tab systems: -
- Nested component tree:
```txt
- src/app/ipo/[ipoId]/page.tsx [819 lines] (root)
  - Accordion -> src/components/ui/accordion.tsx [59 lines] (imported-file)
  - AccordionContent -> src/components/ui/accordion.tsx [59 lines] (imported-file)
  - AccordionItem -> src/components/ui/accordion.tsx [59 lines] (imported-file)
  - AccordionTrigger -> src/components/ui/accordion.tsx [59 lines] (imported-file)
...
- Direct child components: CursiveLoader -> src/components/ui/CursiveLoader.tsx; Tabs -> src/components/ui/tabs.tsx; TabsContent -> src/components/ui/tabs.tsx; TabsList -> src/components/ui/tabs.tsx; TabsTrigger -> src/components/ui/tabs.tsx
- Internal child components: HeatMap, MarketBreadth, MarketIndices, MostActive, SectorPerformance, SectorTooltip, TopMovers
- Intrinsic UI elements: article, div, h1, h3, h4, p, section, span, table, tbody, td, th, thead, tr
- Tab systems: Tabs, TabsList, TabsTrigger, TabsContent
- Nested component tree:
```txt
- src/app/market/page.tsx [1535 lines] (root)
  - CursiveLoader -> src/components/ui/CursiveLoader.tsx [67 lines] (imported-file)
  ...
  - HeatMap -> src/app/market/page.tsx [1535 lines] (internal-component)
  - MarketBreadth -> src/app/market/page.tsx [1535 lines] (internal-component)
  - MarketIndices -> src/app/market/page.tsx [1535 lines] (internal-component)
  - MostActive -> src/app/market/page.tsx [1535 lines] (internal-component)
  - SectorPerformance -> src/app/market/page.tsx [1535 lines] (internal-component)
  - SectorTooltip -> src/app/market/page.tsx [1535 lines] (internal-component)
  - TopMovers -> src/app/market/page.tsx [1535 lines] (internal-component)
```
...
- src/app/portfolio/page.tsx [8 lines] (root)
  - PortfolioDashboard -> src/components/portfolio/PortfolioDashboard.tsx [874 lines] (imported-file)
```
...
- src/app/settings/page.tsx [20 lines] (root)
  - SettingsPageShell -> src/components/settings/SettingsPageShell.tsx [184 lines] (imported-file)
    - LoadingSkeleton -> src/components/ui/LoadingSkeleton.tsx [20 lines] (imported-file)
    ...
    - Reports -> src/components/settings/Reports.tsx [162 lines] (imported-file)
      - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
      - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
      - CardDescription -> src/components/ui/card.tsx [80 lines] (imported-file)
      - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    ...
    - SuspiciousActivity -> src/components/settings/SuspiciousActivity.tsx [186 lines] (imported-file)
      - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
      - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
      - CardDescription -> src/components/ui/card.tsx [80 lines] (imported-file)
      - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
      - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
      - LoadingSkeleton -> src/components/ui/LoadingSkeleton.tsx [20 lines] (imported-file)
      - SummaryTile -> src/components/settings/SuspiciousActivity.tsx [186 lines] (internal-component)
...
- Nested component tree:
```txt
- src/app/stock-search/page.tsx [170 lines] (root)
  - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - EnhancedStockCard -> src/components/stocks/EnhancedStockCard.tsx [275 lines] (imported-file)
  - SearchBar -> src/app/components/SearchBar.tsx [339 lines] (imported-file)
    - StockLogo -> src/app/components/StockLogo.tsx [52 lines] (imported-file)
```
...
- Direct child components: CardContent -> src/components/ui/card.tsx; CardDescription -> src/components/ui/card.tsx; CardHeader -> src/components/ui/card.tsx; CardTitle -> src/components/ui/card.tsx; CursiveLoader -> src/components/ui/CursiveLoader.tsx; EnhancedStockCard -> src/components/stocks/EnhancedStockCard.tsx
...
- Nested component tree:
```txt
- src/app/stocks/page.tsx [2392 lines] (root)
  - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardDescription -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - CursiveLoader -> src/components/ui/CursiveLoader.tsx [67 lines] (imported-file)
  - EnhancedStockCard -> src/components/stocks/EnhancedStockCard.tsx [275 lines] (imported-file)
  - StocksSurfaceCard -> src/app/stocks/page.tsx [2392 lines] (internal-component)
```
...
- Nested component tree:
```txt
- src/app/stocks/[symbol]/page.tsx [1195 lines] (root)
  - CursiveLoader -> src/components/ui/CursiveLoader.tsx [67 lines] (imported-file)
  - ESGMetrics -> src/components/stocks/ESGMetrics.tsx [532 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - FundamentalAnalysis -> src/components/stocks/FundamentalAnalysis.tsx [135 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardDescription -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    ...
    - FinancialStatements -> src/components/stocks/FinancialStatements.tsx [177 lines] (imported-file)
      ...
      - TabsList -> src/components/ui/tabs.tsx [53 lines] (imported-file)
      - TabsTrigger -> src/components/ui/tabs.tsx [53 lines] (imported-file)
  - FutureGrowthPotential -> src/components/stocks/FutureGrowthPotential.tsx [662 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - IndustryAnalysis -> src/components/stocks/IndustryAnalysis.tsx [324 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - InstitutionalInvestment -> src/components/stocks/InstitutionalInvestment.tsx [507 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - MacroeconomicIndicators -> src/components/stocks/MacroeconomicIndicators.tsx [337 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - ManagementGovernance -> src/components/stocks/ManagementGovernance.tsx [429 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - MetricCard -> src/components/stocks/MetricCard.tsx [75 lines] (imported-file)
  ...
  - RiskAssessment -> src/components/stocks/RiskAssessment.tsx [315 lines] (imported-file)
    ...
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - SentimentAnalysis -> src/components/stocks/SentimentAnalysis.tsx [432 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
  - TechnicalAnalysis -> src/components/stocks/TechnicalAnalysis.tsx [513 lines] (imported-file)
    - Card -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardContent -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardHeader -> src/components/ui/card.tsx [80 lines] (imported-file)
    - CardTitle -> src/components/ui/card.tsx [80 lines] (imported-file)
...
| --- | --- | --- | --- |
| /api/health | src/app/api/health/route.ts | 11 | GET |
...
| src/components/home/HeroSection.tsx | Button -> src/components/ui/button.tsx | circle, defs, div, g, h1, line, linearGradient, p, path, section, span, stop, svg | yes | - |
...
| src/components/home/SectorPerformance.tsx | - | div, h3, span | yes | - |
| src/components/IPO/IpoPanels.tsx | Badge -> src/components/ui/badge.tsx; Button -> src/components/ui/button.tsx; Card -> src/components/ui/card.tsx; CardContent -> src/components/ui/card.tsx; CardDescription -> src/components/ui/card.tsx; CardHeader -> src/components/ui/card.tsx; CardTitle -> src/components/ui/card.tsx | a, div, h2, h3, p, section, span | yes | - |
...
| src/components/portfolio/PortfolioDashboard.tsx | - | button, circle, defs, div, form, h2, h3, input, line, linearGradient, option, p, path, section, select, span, stop, svg, table, tbody, td, th, thead, tr | yes | - |
...
| src/components/spotlight-card.tsx | - | div | no | - |
...
| src/components/stocks/TechnicalAnalysis.tsx | Card -> src/components/ui/card.tsx; CardContent -> src/components/ui/card.tsx; CardHeader -> src/components/ui/card.tsx; CardTitle -> src/components/ui/card.tsx; CursiveLoader -> src/components/ui/CursiveLoader.tsx | div, h4, p, span | yes | - |
| src/components/ui/accordion.tsx | - | div | yes | - |
| src/components/ui/animated-underline-text-one.tsx | - | div, h1, path, svg | no | - |
| src/components/ui/badge.tsx | - | div | yes | - |
...
| src/components/ui/LoadingSkeleton.tsx | - | div | yes | - |
...
| src/components/ui/market-network-section.tsx | MarketEntityTicker -> src/components/ui/market-entity-ticker.tsx | div, h2, p | yes | - |
...
| src/components/ui/TypewriterBrandLoader.tsx | - | div, h1, span | no | - |
...
- src/components/ui/TypewriterBrandLoader.tsx
