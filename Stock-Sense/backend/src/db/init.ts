...
export async function initializeTables() {
  try {
    ...
    `);
    logger.info('✅ Sectors table created or confirmed');
    ...
    `);
    logger.info('✅ Stocks table created or confirmed');
    ...
    `);
    logger.info('✅ Stock financial data table created or confirmed');
    ...
    `);
    logger.info('✅ Watchlists table created or confirmed');
    ...
    `);
    logger.info('✅ Watchlist items table created or confirmed');
...
export async function seedData() {
  try {
    ...
    if (parseInt(sectorCount.rows[0].count) === 0) {
      ...
      `);
      logger.info('✅ Sectors data seeded');
    }
