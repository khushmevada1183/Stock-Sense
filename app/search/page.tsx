...
export default function SearchPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="bg-gray-900/90 backdrop-blur-lg rounded-lg shadow-md p-6">
        <form onSubmit={handleSearch} className="relative max-w-xl mx-auto">
          <input
            ...
            className="w-full py-3 pl-12 pr-4 bg-gray-900/90 backdrop-blur-lg border border-gray-300 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
