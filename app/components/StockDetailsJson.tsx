...
const StockDetailsJson: React.FC<StockDetailsJsonProps> = ({ stock, isLoading, error }) => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-40 bg-gray-50 bg-gray-900/90 backdrop-blur-lg rounded-lg p-4">
  ...
  return (
    <div className="w-full overflow-hidden bg-white bg-gray-900/90 backdrop-blur-lg rounded-lg">
