          ...
          <div className="bg-blue-900/30 rounded-xl border border-blue-800 p-4">
            ...
            <div className="space-y-3">
              <div>
                ...
                <select className="w-full px-3 py-2 bg-gray-900/90 backdrop-blur-lg border border-gray-700 rounded-lg text-sm text-white">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full px-3 py-2 bg-gray-900/90 backdrop-blur-lg border border-gray-700 rounded-lg text-sm"
                />
              </div>
