      ...
      <div className="max-w-6xl mx-auto space-y-12">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              <div className="h-20 bg-gray-900/90 backdrop-blur-lg rounded-md"></div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* Icon Button */}
            <div className="space-y-2">
              <button className="p-2 bg-gray-900/90 backdrop-blur-lg text-neon-400 rounded-full hover:bg-gray-900/90 backdrop-blur-lg transition-all duration-300 hover:shadow-neon-sm">
                <Settings size={20} />
              </button>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Standard Card */}
            <div className="bg-gray-900/90 backdrop-blur-lg rounded-lg p-6 hover:shadow-md transition-all duration-300">
              ...
              <div className="h-32 bg-gray-900/90 backdrop-blur-lg rounded-md mb-4"></div>
            ...
            <div className="glass rounded-lg p-6 hover:shadow-md transition-all duration-300">
              ...
              <div className="h-32 bg-gray-900/90 rounded-md mb-4 border border-gray-700/50"></div>
              <button className="text-neon-400 text-sm font-medium flex items-center hover:text-neon-300 transition-colors">
                View Details <ChevronRight size={16} className="ml-1" />
              </button>
            </div>
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Line Chart */}
            <div className="bg-gray-900/90 backdrop-blur-lg rounded-lg p-6">
        ...
        <section className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Neon Glow */}
            <div className="bg-gray-900/90 backdrop-blur-lg rounded-lg p-6 neon-glow">
            ...
            {/* Floating Element */}
            <div className="bg-gray-900/90 backdrop-blur-lg rounded-lg p-6 flex justify-center">
            ...
            {/* Glowing Element */}
            <div className="bg-gray-900/90 backdrop-blur-lg rounded-lg p-6 flex justify-center">
              <button className="px-4 py-2 bg-gray-900/90 backdrop-blur-lg text-neon-400 font-medium rounded-md border border-neon-400/50 animate-glow">
                Premium Feature
              </button>
            </div>
          </div>
