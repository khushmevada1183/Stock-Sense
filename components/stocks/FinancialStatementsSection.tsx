            ...
            <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as any)}>
              ...
              <div className="mb-4">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-900/90 backdrop-blur-lg"
                  />
                </div>
              </div>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm text-left">
                  <thead className="text-xs text-gray-700 dark:text-gray-300 uppercase bg-gray-50 dark:bg-gray-900/90 backdrop-blur-lg">
                    <tr>
                    ...
                    {filteredItems.length > 0 ? (
                      filteredItems.map((item, index) => (
                        <tr 
                          ...
                          className={index % 2 === 0 ? 'bg-gray-900/90 backdrop-blur-lg dark:bg-gray-900/90 backdrop-blur-lg' : 'bg-gray-50 dark:bg-gray-700'}
                        >
