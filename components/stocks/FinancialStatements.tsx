...
export interface FinancialItem { // Exported
  displayName: string;
  key: string;
  value: string;
...
export interface FinancialData { // Exported (this is for stockFinancialMap)
  CAS?: FinancialItem[] | null; // Cash Flow
  BAL?: FinancialItem[] | null; // Balance Sheet
  INC?: FinancialItem[] | null; // Income Statement
}

export interface FinancialPeriod { // Exported
...
export interface FinancialStatementsProps { // Exported
