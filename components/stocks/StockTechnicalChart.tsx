...
const StockTechnicalChart = ({ technicalData, symbol }: StockTechnicalChartProps) => {
  ...
  const CustomTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      ...
      return (
        <div className="bg-gray-900/90 backdrop-blur-lg dark:bg-gray-900/90 backdrop-blur-lg p-3 border border-gray-200 dark:border-gray-700 rounded-md shadow-md">
        ...
        {technicalData.length > 0 ? (
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
              <div className="bg-gray-50 dark:bg-gray-900/90 backdrop-blur-lg p-3 rounded-lg">
