...
const StockDetailsJson: React.FC<StockDetailsJsonProps> = ({ stock, isLoading, error }) => {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-40 bg-gray-900/90 backdrop-blur-lg border border-gray-700/50 shadow-lg rounded-lg p-4">
  ...
  return (
    <div className="bg-gray-900/90 backdrop-blur-lg border border-gray-700/50 shadow-lg rounded-lg p-4 overflow-hidden">
