...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900/90 backdrop-blur-lg dark:bg-gray-950 border-t border border-gray-700/50 shadow-lg noise-bg">
      <div className="container mx-auto px-4 py-6">
        ...
        {/* Copyright */}
        <div className="border-t border border-gray-700/50 shadow-lg mt-4 pt-4 text-center">
