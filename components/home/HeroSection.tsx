      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7">
            ...
            >
              <div className="inline-flex items-center px-3 py-1 rounded-full border border-neon-400/30 bg-gray-900/90 backdrop-blur-lg text-neon-400 text-sm mb-6">
                <span className="animate-pulse mr-2 h-2 w-2 rounded-full bg-neon-400"></span>
                Real-time market intelligence
              </div>
              
              <h1 className="text-4xl md:text-6xl font-bold mb-6 tracking-tight">
                <span className="text-white bg-clip-text text-transparent bg-gradient-to-r from-neon-300 to-cyan-400">
                  Gain the Edge with 
                </span>
                <br />
              ...
              <div className="flex flex-wrap gap-4 mb-12">
                ...
                <Link
                  href="/stocks"
                  className="group px-8 py-4 bg-gray-900/90 backdrop-blur-lg text-white font-medium rounded-lg border border-neon-400/20 hover:bg-gray-900/90 backdrop-blur-lg/70 hover:border-neon-400/40 transition-all duration-300 hover:shadow-neon-sm"
                >
            ...
            >
              ...
              <div className="relative h-[400px] w-full glass-premium rounded-2xl border border-neon-400/10 shadow-neon-lg overflow-hidden">
                ...
                <div className="absolute top-4 left-4 right-4 flex justify-between items-center">
                  <div className="text-xs font-mono bg-gray-900/90 backdrop-blur-lg px-3 py-1 rounded-full text-neon-400 flex items-center border border-gray-700/50">
                    <span className="animate-pulse mr-1.5 h-1.5 w-1.5 rounded-full bg-neon-400"></span>
                    LIVE DATA
                  </div>
                  <div className="text-xs font-mono bg-gray-900/90 backdrop-blur-lg px-3 py-1 rounded-full text-neon-400 border border-gray-700/50">
                ...
                <div className="absolute bottom-4 left-4 right-4 grid grid-cols-3 gap-2">
                  <div className="bg-gray-900/90 backdrop-blur-lg p-2 rounded-lg border border-gray-700/50">
