...
//         {/* Mobile Menu */}
//         {isMobileMenuOpen && (
//           <div className="fixed inset-x-0 top-[60px] mx-4 lg:hidden py-3 sm:py-4 bg-blur-1 backdrop-blur-x100 rounded-xl shadow-lg px-3 sm:px-4 border border-gray-800/30 glass">
