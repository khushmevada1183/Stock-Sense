  ...
  return (
    <header className="sticky top-0 z-50 w-full">
      <div className="mx-auto w-[98%] sm:w-[95%] px-1 sm:px-2 pt-2 sm:pt-4">
        <div className="bg-gray-950/40 backdrop-blur-xl rounded-full shadow-lg border border-gray-800/20">
                ...
                <Link
                  ...
                  href={item.href}
                      className={`flex items-center px-3 py-1.5 rounded-full transition-all duration-200 ${
                        ...
                        active
                          ? 'bg-gray-900/90 backdrop-blur-lg text-neon-400 shadow-neon-sm'
                          : 'text-gray-300 hover:text-neon-400 hover:bg-gray-900/90 backdrop-blur-lg/40'
                      }`}
                    >
          ...
          {/* Mobile Menu */}
          {isMobileMenuOpen && (
            <div className="absolute inset-x-4 top-16 lg:hidden py-3 sm:py-4 bg-gray-950/90 backdrop-blur-xl rounded-xl shadow-lg px-3 sm:px-4 border border-gray-800/30">
