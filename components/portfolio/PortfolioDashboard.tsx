  ...
  return (
    <div ref={dashboardRef} className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Risk Profile Card */}
        <div className="dashboard-card bg-gray-900/90 backdrop-blur-lg glass rounded-xl p-6 shadow-lg">
      ...
      {/* Holdings Table */}
      <div className="dashboard-card bg-gray-900/90 backdrop-blur-lg glass rounded-xl p-6 shadow-lg overflow-x-auto">
