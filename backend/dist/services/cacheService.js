...
exports.cacheService = exports.DEFAULT_TTL = void 0;
...
class CacheService {
    constructor() {
        this.memoryCache = new node_cache_1.default(); // Initialize with default values
        ...
        this.memoryCache = new node_cache_1.default({ stdTTL: exports.DEFAULT_TTL.MARKET_DATA, checkperiod: 120 });
        if (this.useRedis) {
            try {
    ...
    static getTTL(dataType) {
        return exports.DEFAULT_TTL[dataType] || exports.DEFAULT_TTL.MARKET_DATA;
    }
}
// Singleton instance
