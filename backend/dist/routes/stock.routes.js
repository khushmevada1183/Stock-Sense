...
router.get('/watchlist', auth_middleware_1.authenticate, async (req, res) => {
    try {
...
router.post('/watchlist', auth_middleware_1.authenticate, async (req, res) => {
...
router.delete('/watchlist/:stockId', auth_middleware_1.authenticate, async (req, res) => {
    try {
...
router.get('/:symbol/prices', async (req, res) => {
    try {
        ...
        const priceHistory = await stockApiService.getStockPriceHistory(symbol, range);
        if (!priceHistory) {
