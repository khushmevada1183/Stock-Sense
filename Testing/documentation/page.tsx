  ...
  "error": "Detailed error"    // On error
      ...
      <div className="grid grid-cols-1 gap-8">
        {endpoints.map((endpoint, index) => (
          <div key={index} className="border border-gray-200 dark:border-gray-700 rounded-lg p-6 bg-gray-900/90 backdrop-blur-lg dark:bg-gray-800 shadow-sm">
              ...
              <div className="mb-4">
                ...
                <div className="overflow-x-auto">
                  <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody className="bg-gray-900/90 backdrop-blur-lg dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
