...
import { FinancialItem, FinancialPeriod } from '@/components/stocks/FinancialStatements';
...
export default function StockDetailClient() {
  ...
  const [stockData, setStockData] = useState<unknown | null>(null);
  ...
  const recentNews: React.ComponentProps<typeof Overview>['recentNews'] = [];
  const tabs = [
    {
      id: 'overview',
      label: 'Overview',
