...
const SignupPage: React.FC = () => {
  ...
  return (
    <div className="auth-shell relative h-screen w-screen overflow-hidden bg-gradient-to-br from-green-500 via-blue-600 to-purple-500">
      <div className="auth-shell-overlay absolute inset-0 bg-gradient-to-br from-green-500/90 via-blue-600/90 to-purple-500/90">
        ...
        <div className="hidden px-6 text-center text-white sm:block sm:w-1/2 lg:w-3/5">
          <div className="mx-auto max-w-xl">
            <div className="mb-8">
              ...
              <h2 className="auth-title mb-4 text-4xl font-bold">Join Stock Sense</h2>
              <p className="auth-copy text-xl opacity-90">Start your market research journey with curated data and powerful analytics.</p>
            </div>
        ...
        <div className="flex w-full max-w-md items-center justify-center sm:w-1/2 sm:max-w-lg lg:w-2/5">
          <div className="auth-panel m-[15px] max-h-[calc(100vh-30px)] w-full overflow-y-auto rounded-2xl border border-white/40 bg-white/95 p-6 shadow-2xl backdrop-blur-sm dark:border-slate-700/70 dark:bg-slate-900/95 sm:p-8">
            <div className="mb-6 flex items-center justify-between">
              <div className="auth-badge flex h-10 w-10 items-center justify-center rounded-full bg-green-100 sm:h-12 sm:w-12">
                <UserPlus className="h-5 w-5 text-emerald-600 sm:h-6 sm:w-6 dark:text-emerald-400" />
              </div>
            ...
            <div className="mb-6">
              <h1 className="auth-title mb-2 text-2xl font-bold text-gray-900 dark:text-slate-100 sm:text-3xl">Create Account</h1>
            </div>

            {error && (
              <div className="auth-feedback-error mb-6 flex items-center rounded-lg border border-red-200 border-l-4 border-l-red-500 bg-red-50 p-4 shadow-sm dark:border-red-500/50 dark:bg-red-950/60">
                ...
                <div>
                  <p className="text-sm font-medium text-red-700 dark:text-red-300 sm:text-base">{error}</p>
                  {error.includes('Passwords do not match') && (
                    <p className="mt-1 text-xs text-red-600 dark:text-red-300">Please make sure both password fields contain the same value.</p>
                  )}
                </div>
              </div>
            )}
            ...
            <form onSubmit={handleRegister} className="space-y-3">
              ...
              <div>
                <label htmlFor="name" className="auth-label mb-1 block text-sm font-medium text-gray-700 dark:text-slate-200">
                  Full Name
                </label>
                <div className="relative">
                  <User className="auth-muted absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 transform text-gray-400 dark:text-slate-400" />
                  <input
                    id="name"
                    type="text"
                    name="name"
              ...
              <div className="flex items-center pt-1">
                <input
                  ...
                  className="auth-input h-4 w-4 rounded border-gray-300 bg-white accent-blue-600 focus:ring-2 focus:ring-blue-500 focus:ring-offset-0 dark:border-slate-500 dark:bg-slate-800"
                  required
                />
                <label htmlFor="acceptTerms" className="auth-muted ml-2 text-xs text-gray-600 dark:text-slate-300">
                  I agree to the{' '}
                  <Link href="/terms" className="auth-link text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="auth-link text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300">
                    Privacy Policy
                  </Link>
                </label>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="auth-button-primary mt-3 w-full rounded-xl bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-2 text-base font-semibold text-white shadow-lg transition-all duration-200 hover:from-blue-700 hover:to-blue-800 focus:ring-4 focus:ring-blue-200 disabled:cursor-not-allowed disabled:opacity-50"
              >
            ...
            <div className="mt-4">
              <p className="auth-muted mb-3 text-center text-xs text-gray-500 dark:text-slate-400">OR SIGN UP WITH</p>
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                ...
                <button
                  ...
                  className="auth-social-button col-span-2 flex flex-col items-center justify-center rounded-xl border border-gray-200 px-2 py-3 transition-colors duration-200 hover:bg-gray-50 dark:border-slate-600 dark:hover:bg-slate-800 sm:col-span-1"
                >
            ...
            <div className="mt-4 text-center">
              <p className="auth-muted text-sm text-gray-600 dark:text-slate-300">
