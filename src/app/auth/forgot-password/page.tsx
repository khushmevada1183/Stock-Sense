...
export default function ForgotPasswordPage() {
  ...
  return (
    <div className="auth-shell relative h-screen w-screen overflow-hidden bg-gradient-to-br from-orange-500 via-red-600 to-purple-500">
      <div className="auth-shell-overlay absolute inset-0 bg-gradient-to-br from-orange-500/90 via-red-600/90 to-purple-500/90">
      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center sm:flex-row">
        <div className="hidden px-6 text-center text-white sm:block sm:w-1/2 lg:w-3/5">
          <div className="mx-auto max-w-xl">
            <div className="mb-8">
              ...
              <h2 className="auth-title mb-4 text-4xl font-bold">Reset Password</h2>
              <p className="auth-copy text-xl opacity-90">Do not worry, we will help you get back into your account quickly.</p>
            </div>
        ...
        <div className="flex w-full max-w-md items-center justify-center sm:w-1/2 sm:max-w-lg lg:w-2/5">
          <div className="auth-panel m-[15px] max-h-[calc(100vh-30px)] w-full overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl sm:p-8">
            <div className="mb-6 flex items-center justify-between">
              <div className="auth-badge flex h-10 w-10 items-center justify-center rounded-full bg-orange-100 sm:h-12 sm:w-12">
                <svg className="h-5 w-5 text-emerald-600 sm:h-6 sm:w-6 dark:text-emerald-400" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 1L3 5V11C3 16.55 6.84 21.74 12 23C17.16 21.74 21 16.55 21 11V5L12 1Z" />
                </svg>
              </div>
            ...
            <div className="mb-6">
              <h1 className="auth-title mb-2 text-2xl font-bold text-gray-900 sm:text-3xl">Forgot Password?</h1>
              <p className="auth-copy text-sm text-gray-600 sm:text-base">Enter your email and we will send an 8-character reset code.</p>
            </div>

            {error ? (
              <div className="auth-feedback-error mb-6 flex items-center rounded-lg border border-red-200 border-l-4 border-l-red-500 bg-red-50 p-4 shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="email" className="auth-label mb-1 block text-sm font-medium text-gray-700">
                  Email Address
                </label>
                <input
                  id="email"
                  ...
                  className="auth-input w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-2 text-sm text-gray-900 placeholder-gray-400 transition-all duration-200 focus:border-blue-500 focus:bg-white focus:ring-2 focus:ring-blue-500"
                  required
                />
              </div>
            ...
            <div className="mt-6 text-center">
              <Link href="/login" className="auth-link inline-flex items-center text-sm font-medium text-blue-600 hover:text-blue-700">
