              ...
              {[
                ...
                <div key={topic.topic} className="bg-gray-900 border border-gray-800 rounded-xl p-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {topic.tags.map((tag) => (
                      <span key={tag} className="text-xs px-2 py-1 bg-gray-900/90 backdrop-blur-lg text-gray-300 rounded-full">
                        #{tag}
                      </span>
                    ))}
                  </div>
          ...
          <div className="bg-gray-900 rounded-xl border border-gray-800 p-4">
            ...
            <div className="flex flex-wrap gap-2">
              {[
                ...
                <div 
                  key={hashtag.tag} 
                  className="text-xs px-3 py-1.5 bg-gray-900/90 backdrop-blur-lg hover:bg-gray-700 text-gray-300 rounded-full flex items-center gap-1.5 cursor-pointer transition-colors"
                >
