  ...
  return (
    ...
    >
        ...
        <section 
          ...
          className="bg-gray-900/90 backdrop-blur-lg rounded-xl shadow-lg p-8 border border-gray-700 glass-premium mb-12 relative overflow-hidden"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCourses.map((course) => (
              <div 
                key={course.id} 
                className="bg-gray-900/90 backdrop-blur-lg rounded-xl shadow-md overflow-hidden border border-gray-700 hover:border-neon-400/50 transition-colors glass-premium"
              >
        ...
        <section ref={addToSectionsRefs}>
          <div className="bg-gray-900/90 backdrop-blur-lg rounded-xl shadow-lg p-8 border border-neon-400/20 glass-premium">
