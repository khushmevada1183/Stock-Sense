...
const LoginContent: React.FC = () => {
  ...
  return (
    <div className="relative h-screen w-screen overflow-hidden bg-gradient-to-br from-blue-500 via-purple-600 to-pink-500">
      ...
      <div className="relative flex h-full w-full flex-col items-center justify-center sm:flex-row">
        <div className="hidden px-6 text-center text-white sm:block sm:w-1/2 lg:w-3/5">
          <div className="mx-auto max-w-xl">
            <div className="mb-8">
              ...
              <h2 className="mb-4 text-4xl font-bold">Welcome to Stock Sense</h2>
              <p className="text-xl opacity-90">Discover market intelligence and AI-driven stock insights from one dashboard.</p>
            </div>
        ...
        <div className="flex w-full max-w-md items-center justify-center sm:w-1/2 sm:max-w-lg lg:w-2/5">
          <div className="m-[15px] max-h-[calc(100vh-30px)] w-full overflow-y-auto rounded-2xl bg-white p-6 shadow-2xl sm:p-8">
            ...
            <div className="mb-6">
              <h1 className="mb-2 text-2xl font-bold text-gray-900 sm:text-3xl">Login</h1>
            </div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <Link href="/auth/sessions" className="text-gray-500 hover:text-gray-700">
                  Security sessions
                </Link>
              </div>
