    ...
    <section className="py-16">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link
            href="/about"
            className="px-8 py-4 bg-gray-900/90 backdrop-blur-lg text-white font-semibold rounded-lg border border-neon-400/20 hover:bg-gray-900/90 backdrop-blur-lg/70 hover:border-neon-400/40 transition-all duration-300 hover:shadow-neon-sm"
          >
            Learn More
          </Link>
        </div>
