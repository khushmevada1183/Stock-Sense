...
const MetricCard = ({ title, children, className = "" }: MetricCardProps) => {
  ...
  return (
    <div 
      ref={cardRef} 
      className={`bg-gray-900/90 backdrop-blur-lg rounded-xl p-4 shadow-lg border border-gray-700/50 h-full ${className}`}
    >
      ...
      <div className="dashboard-header flex justify-between items-center mb-6 border-b border-gray-700 pb-4">
        ...
        <div className="flex space-x-4">
          {indices.slice(0, 2).map((index) => (
            <div key={index.code} className="bg-gray-900/90 backdrop-blur-lg px-4 py-2 rounded-lg border border-gray-700">
