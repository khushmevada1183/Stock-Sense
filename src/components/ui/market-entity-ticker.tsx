        ...
        {entities.map((entity) => {
          ...
          return (
            <div
              ...
              className="pointer-events-none flex min-w-[320px] items-center gap-4 rounded-full border border-slate-200 bg-white/95 px-4 py-2.5 shadow-sm dark:border-white/10 dark:bg-white/5"
            >
