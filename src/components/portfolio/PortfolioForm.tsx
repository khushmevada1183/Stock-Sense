    ...
    <div className="max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          {stocks.length > 0 ? (
            <div className="border border-gray-200 dark:border-gray-700 rounded-md overflow-hidden mb-4">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-900/90 backdrop-blur-lg">
                  <tr>
                ...
                <tbody className="bg-gray-900/90 backdrop-blur-lg dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div className="bg-gray-50 dark:bg-gray-900/90 backdrop-blur-lg p-4 rounded-md text-center mb-4">
          ...
          {/* Add New Stock Form */}
          <div className="bg-gray-50 dark:bg-gray-900/90 backdrop-blur-lg p-4 rounded-md">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="relative">
                ...
                {symbolSearchResults.length > 0 && (
                  <div className="absolute z-10 w-full mt-1 bg-gray-900/90 backdrop-blur-lg dark:bg-gray-900/90 backdrop-blur-lg border border-gray-300 dark:border-gray-700 rounded-md shadow-lg">
                    {isSearching ? (
        ...
        <div className="flex justify-end space-x-4">
          <button
            ...
            className="px-4 py-2 border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-md hover:bg-gray-50 dark:hover:bg-gray-900/90 backdrop-blur-lg"
          >
            Cancel
          </button>
          <button
